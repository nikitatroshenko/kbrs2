...
public class AesEncoder implements Encoder {
    ...
    private static AesEncoder instance;
    ...
    @Override
    public String decrypt(String encryptedIvText, String key) throws Exception {
        int ivSize = 16;
        int keySize = 16;

        // Extract IV.
        byte[] encryptedIvTextBytes = Hex.decodeHex(encryptedIvText);
        byte[] iv = new byte[ivSize];
